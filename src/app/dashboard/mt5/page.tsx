        ...
        <div className="glass-panel p-8 md:p-16">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
              {[
                { title: 'MT5 Configuration', desc: 'Go to Tools > Options > Expert Advisors. Check "Allow WebRequest" and add: http://129.159.218.33.sslip.io and http://backend.129.159.218.33.sslip.io' },
